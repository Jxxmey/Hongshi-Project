      ...
      timer = setInterval(() => {
        setProgress((prev) => {
          ...
          if (nextProgress >= 100) {
            ...
            // Automatically transition to the main app after a short delay when complete
            setTimeout(() => {
      ...
      <style>
        {`
          ...
          .cake-stage {
            ...
            width: 285px;
            animation: cake-float 3.7s ease-in-out infinite;
          }
          ...
          .cake-shadow {
            ...
            bottom: 5px;
            border-radius: 50%;
            background: rgba(104, 107, 132, .13);
            animation: shadow-pulse 3.7s ease-in-out infinite;
          }
          ...
          .plate {
            ...
            border-radius: 50%;
            background: #d5e8f5;
            box-shadow: inset 0 -7px 0 #afcfe3;
          }
          ...
          .cake-base {
            ...
            box-shadow: inset 0 -14px 0 #ed7fa6, 0 7px 0 rgba(99,174,226,.18);
          }
          ...
          .cake-base::before {
            ...
            border-radius: 99px;
            background: rgba(255,255,255,.68);
            box-shadow: 29px 14px 0 rgba(255,255,255,.68), 69px 4px 0 rgba(255,255,255,.68), 111px 15px 0 rgba(255,255,255,.68);
          }
          ...
          .frosting {
            ...
            box-shadow: inset 0 -8px 0 #f7d7e4;
          }
          ...
          .frosting::after {
            ...
            background: #fff8fc;
            box-shadow: 36px 7px 0 #fff8fc, 80px 1px 0 #fff8fc, 125px 7px 0 #fff8fc;
          }
          ...
          .candle {
            ...
            background: repeating-linear-gradient(135deg, #92cdf3 0 5px, #ffffff 5px 10px);
            border: 2px solid #72b5df;
          }
          ...
          .flame {
            ...
            background: #ffd36d;
            box-shadow: 0 0 0 4px rgba(255, 186, 85, .19), 0 0 19px rgba(255, 185, 74, .7);
          ...
          .progress-fill {
            ...
            background: linear-gradient(90deg, #ff82ae, #ffafcb 54%, #91cff4);
            box-shadow: 0 2px 8px rgba(235, 100, 154, .35);
          ...
          .complete-panel {
            ...
            padding: 18px;
            border-radius: 21px;
            background: rgba(255, 239, 246, .78);
            animation: pop .45s cubic-bezier(.18,.89,.32,1.28) both;
          }

          .complete-title { margin: 0 0 5px; font-family: "Fraunces", serif; }
          .complete-message { margin: 0 0 13px; font-size: .9rem; line-height: 1.45; }
          ...
          <section className="loading-card" aria-live="polite">
            ...
            {isComplete && (
              <section className="complete-panel">
                <h2 className="complete-title">Ready!</h2>
                <p className="complete-message">Welcome to the celebration.</p>
              </section>
            )}
          </section>
        </main>
